...
export const ROLE_DEFAULT_PERMISSIONS: Record<StaffRoleName, PermissionMatrix> = {
  ...
  "Finance Officer": buildPermissionMatrix({
    ...
    "Free Webinar - Finance": ["view", "edit", "verify"],
  ...
  "Marketing Staff": buildPermissionMatrix({
    ...
    "Free Webinar - Marketing": VIEW_ONLY,
    "Communications - Templates": ALL_ACTIONS,
    Communications: VIEW_ONLY,
    Reports: VIEW_ONLY,
    Tasks: VIEW_EDIT,
    Calendar: VIEW_ONLY,
  }),
